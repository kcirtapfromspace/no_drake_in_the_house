...
mod user_model_tests {
    ...
    fn test_to_profile() {
        ...
        assert_eq!(
            profile.oauth_accounts[0].provider,
    ...
    fn test_merge_from() {
        ...
        let google_account =
            create_test_oauth_account(OAuthProviderType::Google, secondary_user.id);
        let github_account =
            create_test_oauth_account(OAuthProviderType::GitHub, secondary_user.id);
