...
<div class="sticky top-0 bg-white border-b border-gray-200 p-4 z-10">
  ...
  <div class="relative">
    ...
    <input
      ...
      class="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-lg"
    />
        ...
        {#each $dnpStore.searchResults as artist}
          <div class="flex items-center justify-between p-4 border-b border-gray-100 last:border-b-0 hover:bg-gray-50">
            <div class="flex items-center space-x-3">
              ...
              <div>
                <h4 class="font-medium text-gray-900">{artist.canonical_name}</h4>
