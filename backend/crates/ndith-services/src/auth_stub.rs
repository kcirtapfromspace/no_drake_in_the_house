use ndith_core::models::{User, CreateUserRequest, LoginRequest, TokenPair};
use anyhow::Result;
use uuid::Uuid;
...
impl AuthService {
    ...
    pub async fn register_user(&self, _request: CreateUserRequest) -> Result<User> {
        ...
        Ok(User {
            ...
            last_login: None,
            settings: ndith_core::models::UserSettings {
    ...
    pub fn verify_token(&self, _token: &str) -> Result<ndith_core::models::Claims> {
        // Stub implementation
        Ok(ndith_core::models::Claims {
