...
impl DnpListService {
    ...
    pub async fn get_dnp_list(
        &self,
        user_id: Uuid,
    ) -> Result<Vec<ndith_core::models::DnpEntryWithArtist>> {
        use ndith_core::models::DnpEntryWithArtist;
    ...
    pub async fn add_to_dnp_list(
        ...
        tags: Option<Vec<String>>,
        note: Option<String>,
    ) -> Result<ndith_core::models::DnpEntry> {
        use ndith_core::models::DnpEntry;
