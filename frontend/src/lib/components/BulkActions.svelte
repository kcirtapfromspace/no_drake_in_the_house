  ...
  <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
    ...
    <div class="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
      <button
        ...
        class="text-zinc-400 hover:text-indigo-500 text-center sm:text-left"
      >
        Clear selection
      </button>
      ...
      <button
        ...
        class="flex items-center justify-center px-3 py-2 border border-transparent text-zinc-400 leading-4 font-medium rounded-uswds-md bg-red-100 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
      >
