use music_streaming_blocklist_backend::{
    AppState, create_router, AuthService, RateLimitService, AuditLoggingService, 
    DnpListService, UserService, DatabaseConfig, initialize_database, 
    RedisConfiguration, create_redis_pool, MonitoringSystem, MonitoringConfig,
    services::user::UpdateUserProfileRequest,
