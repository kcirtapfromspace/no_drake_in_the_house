...
mod tests {
    use super::*;
    use ndith_core::models::{SpotifyAlbum, SpotifyArtist, SpotifyTrack};
    use std::collections::HashMap;
    ...
    async fn test_featured_artist_detection_from_title() {
        let spotify_service = Arc::new(
            SpotifyService::new(
                crate::spotify::SpotifyConfig::default(),
                Arc::new(crate::TokenVaultService::new()),
            )
            .unwrap(),
        );
