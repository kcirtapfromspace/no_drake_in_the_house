...
use crate::databases::{Collaboration, SharedGraphStore};
...
impl CollaborationBuilder {
    ...
    pub async fn get_artist_collaboration_stats(
        ...
        let network = self.graph.get_artist_network(&artist_id.to_string(), 1)?;
...
impl CollaborationService {
    pub fn new(graph: SharedGraphStore, pool: PgPool) -> Self {
        Self {
            builder: CollaborationBuilder::new(graph, pool, CollaborationBuilderConfig::default()),
        }
    }
    ...
    pub fn with_config(
        ...
        Self {
            builder: CollaborationBuilder::new(graph, pool, config),
        }
    }
