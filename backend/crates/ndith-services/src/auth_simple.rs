...
use ndith_core::models::{Claims, CreateUserRequest, LoginRequest, TokenPair, User, UserSettings};
use rand::Rng;
use sqlx::PgPool;
use uuid::Uuid;
...
impl AuthService {
    ...
    pub async fn setup_totp(
        &self,
        _user_id: Uuid,
    ) -> Result<ndith_core::models::TotpSetupResponse> {
        // Simplified implementation for testing
        Err(anyhow!(
    ...
    pub async fn create_session(
        ...
        _user_id: Uuid,
        _device_info: String,
    ) -> Result<ndith_core::models::Session> {
        // Simplified implementation for testing
        Err(anyhow!(
    ...
    pub async fn get_user_sessions(
        &self,
        _user_id: Uuid,
    ) -> Result<Vec<ndith_core::models::Session>> {
        // Simplified implementation for testing
        Ok(Vec::new())
    }
    ...
    pub async fn oauth_login(
        &self,
        _request: ndith_core::models::OAuthLoginRequest,
    ) -> Result<TokenPair> {
        // Simplified implementation for testing
        Err(anyhow!(
