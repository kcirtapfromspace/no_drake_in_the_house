use crate::login_performance::LoginPerformanceService;
use crate::oauth::{OAuthProvider, OAuthStateManager};
use crate::oauth_apple::AppleOAuthProvider;
use crate::oauth_config_validator::OAuthConfigValidator;
...
use ndith_core::models::user::{MergeAccountsRequest, MergeAccountsResponse};
...
impl AuthService {
    ...
    pub fn get_oauth_config_validation(
        &self,
    ) -> &HashMap<OAuthProviderType, crate::oauth_config_validator::OAuthProviderValidation> {
    ...
    pub fn get_oauth_user_guidance(
        &self,
        oauth_error: &ndith_core::error::oauth::OAuthError,
    ) -> crate::oauth_error_recovery::UserGuidance {
    ...
    ) -> crate::oauth_error_recovery::ProviderHealthStatus {
    ...
    pub async fn get_oauth_security_stats(
        ...
        hours: i64,
    ) -> crate::oauth_security_logger::SecurityStats {
    ...
    pub async fn get_oauth_security_events(
        ...
        provider: Option<OAuthProviderType>,
        hours: i64,
    ) -> Vec<crate::oauth_security_logger::OAuthSecurityEvent> {
        self.oauth_security_logger
    ...
    async fn validate_oauth_provider_health(&self, provider: &OAuthProviderType) -> Result<()> {
        use crate::oauth_error_recovery::ProviderHealthStatus;
        ...
        match health_status {
            ...
            ProviderHealthStatus::Unavailable {
                reason,
                estimated_recovery,
            } => Err(ndith_core::error::AppError::OAuth(
                ndith_core::error::oauth::OAuthError::ProviderUnavailable {
                    provider: *provider,
                    reason,
                    estimated_recovery,
                    retry_after: Some(60),
            ...
            .execute_with_recovery(provider_type, "initiate_oauth_flow", move || {
                ...
                Box::pin(async move {
                    let provider = providers.get(&provider_type_clone).ok_or_else(|| {
                        ndith_core::error::AppError::OAuth(
                            ndith_core::error::oauth::OAuthError::ProviderNotConfigured {
                    ...
                    let state = ndith_core::models::oauth::OAuthState::new(
                        provider_type_clone,
                        redirect_uri,
    ...
    pub async fn complete_oauth_flow(
        ...
        let _oauth_state = self
            ...
            .map_err(|e| {
                let oauth_error = ndith_core::error::oauth::OAuthError::StateValidationFailed {
                    reason: e.to_string(),
                ...
                ndith_core::error::AppError::OAuth(oauth_error)
            })?;
    ...
    pub async fn validate_registration_request(
        &self,
        request: &ndith_core::models::RegisterRequest,
    ...
    pub async fn register(
        &self,
        request: ndith_core::models::RegisterRequest,
    ) -> Result<ndith_core::models::AuthResponse> {
        use ndith_core::models::AuthResponse;
        ...
        if !validation_errors.is_empty() {
            ...
            return Err(ndith_core::AppError::RegistrationValidationError {
        ...
        if email_exists {
            ...
            return Err(ndith_core::AppError::EmailAlreadyRegistered);
        }
    ...
    pub async fn login(&self, request: LoginRequest) -> Result<ndith_core::models::AuthResponse> {
        use ndith_core::models::AuthResponse;
    ...
    pub async fn setup_2fa(&self, user_id: Uuid) -> Result<ndith_core::models::TotpSetupResponse> {
    ...
    async fn find_user_by_oauth_account_public_impl_disabled(
        ...
        match user_row {
            Some(row) => Ok(User {
                ...
                updated_at: row.updated_at.unwrap_or(Utc::now()),
                last_login: row.last_login,
                settings: ndith_core::models::user::UserSettings {
