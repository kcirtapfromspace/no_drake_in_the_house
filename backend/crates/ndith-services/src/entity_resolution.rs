use ndith_core::models::{Artist, ArtistAlias, ArtistSearchQuery, ArtistResolutionResult, MatchType};
use crate::ExternalApiService;
use dashmap::DashMap;
...
mod tests {
    use super::*;
    use ndith_core::models::ExternalIds;
