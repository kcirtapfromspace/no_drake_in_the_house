...
use ndith_core::models::UserSettings;
...
pub use ndith_core::models::UserProfile;
...
impl UserService {
    ...
    async fn get_oauth_accounts(
        &self,
        user_id: Uuid,
    ) -> Result<Vec<ndith_core::models::OAuthAccountInfo>> {
        ...
        Ok(accounts
            ...
            .map(
                |(
                    ...
                    ndith_core::models::OAuthAccountInfo {
