          ...
          {#if userMenuOpen}
            <div class="absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 z-50 surface-card-thin" >
              ...
              <button
                ...
                class="w-full text-left px-4 py-2 text-sm text-red-400 hover:bg-red-900/30 flex items-center"
              >
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="px-4 py-4 border-t border-zinc-700" >
        ...
        <div class="space-y-1">
          ...
          <button
            type="button"
            on:click={handleLogout}
            class="w-full flex items-center px-3 py-2 rounded-md text-base font-medium text-red-400 hover:bg-red-900/30"
          >
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
            </svg>
